...
// O'Brien Plumbing colors - trust blue, safety orange
const levelConfig = {
  info: {
    icon: Info,
    bgColor: 'bg-trust-600',
    borderColor: 'border-trust-400',
    textColor: 'text-white',
    iconColor: 'text-trust-200'
  },
  warning: {
    icon: AlertCircle,
    bgColor: 'bg-safety-600',
    borderColor: 'border-safety-400',
    textColor: 'text-white',
    iconColor: 'text-safety-200'
  },
  urgent: {
    icon: AlertTriangle,
    bgColor: 'bg-red-600',
