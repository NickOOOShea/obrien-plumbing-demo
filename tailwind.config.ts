...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary - Trust Blue (dependable, professional)
        trust: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Secondary - Safety Orange (emergency, action)
        safety: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
      ...
      boxShadow: {
        ...
        'trust': '0 4px 14px 0 rgba(37, 99, 235, 0.25)',
        'safety': '0 4px 14px 0 rgba(234, 88, 12, 0.25)',
      },
    },
  },
  plugins: [
